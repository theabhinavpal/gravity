...
export function SplineSceneBasic() {
  return (
    <Card className="w-full h-[700px] bg-gradient-to-b from-black to-neutral-950 relative overflow-hidden border-white/10 shadow-2xl">
      ...
      <div className="relative z-10 flex h-full flex-col md:flex-row pointer-events-none">
        ...
        <motion.div 
          ...
          initial="initial"
          animate="animate"
          className="flex-1 p-12 flex flex-col justify-center -translate-y-6 will-change-transform"
        >
          <motion.h1 
            variants={fadeIn}
            className="text-6xl md:text-8xl font-black bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 uppercase tracking-tighter leading-none"
          >
            Digital <span className="text-primary italic-emphasis">Gravity</span>
          </motion.h1>
          <motion.p 
            variants={fadeIn}
            className="mt-8 text-neutral-400 max-w-xl text-xl font-light leading-relaxed"
          >
